...
# - 주소 입력
browser.get("https://search.naver.com/search.naver?where=news&query=%EC%BD%94%EB%A6%AC%EB%B9%99%ED%95%98%EC%9A%B0%EC%8A%A4&sm=tab_opt&sort=0&photo=0&field=0&pd=5&ds=2023.03.07&de=2024.03.06&docid=&related=0&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so%3Ar%2Cp%3A1y&is_sug_officeid=0&office_category=0&service_area=0")
